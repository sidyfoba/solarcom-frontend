// src/components/TicketCreateTemplate.tsx
...
/* TODO:
   - Update the edit dialog to support DateRange / Sla-priority / Editor if needed.
*/
...
interface Sla {
  priorityLabel: string; // criticity or priority
  sla: number; // in hours
}
...
interface Field {
  id: number | string;
  name: string;
  type: string; // "String" | "Number" | "Date" | "Select" | "DateRange" | "Sla-priority" | "Editor"
  options: string[];
  required: boolean;
  dateRange?: DateRange;
  slas?: Sla[];
...
const TicketCreateTemplate: FC = () => {
  ...
  const handleSlaChange = (index: number, value: string) => {
    ...
    if (value === "" || numberValue >= 0) {
      setSlas((prev) => {
        const updated = [...prev];
        updated[index].sla = numberValue;
        return updated;
      });
    }
  };

  const handleSlaSelectChange = (
    fieldId: number | string,
    selected: Sla | null
  ) => {
    setFields((prevFields) =>
      prevFields.map((field) =>
        field.id === fieldId ? { ...field, selectedSla: selected } : field
      )
    );
  };

  // When Excel headers change, auto-populate base fields
  useEffect(() => {
  ...
  const handleAddField = () => {
    ...
    const newField: Field = {
      ...
      dateRange:
        fieldType === "DateRange"
          ? {
              startName: startCustomName || "Start Date",
              endName: endCustomName || "End Date",
              startDateTime: "",
              endDateTime: "",
            }
          : undefined,
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      handleClearForm();
      setSnackbarMessage("Ticket template submitted successfully.");
          ...
          <Stack spacing={3}>
            ...
            <Box>
              ...
              <Typography variant="subtitle1" color="text.secondary">
                Define reusable ticket templates with SLA, date ranges and more,
                manually or by importing from Excel.
              </Typography>
            </Box>
                  ...
                  <Box>
                    ...
                    <Stack spacing={2}>
                      <TextField
                        ...
                        required
                        placeholder="e.g. Trouble Ticket Template"
                      />
                      <TextField
                        fullWidth
                        label="Description"
                        ...
                        multiline
                        minRows={2}
                        placeholder="Short description of what this ticket template is used for."
                      />
                    </Stack>
                  </Box>
                      ...
                      >
                        {fields.length === 0 && (
                          <Typography
                            ...
                            sx={{ fontStyle: "italic" }}
                          >
                            No fields added yet. Use the form below to add one
                              ...
                              >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      {field.slas?.map((sla, index) => (
                                        ...
                                        >
                                          {sla.priorityLabel} (SLA: {sla.sla} h)
                                        </MenuItem>
                                      ))}
                                    </Select>
                                  </FormControl>
                                ...
                                {field.type === "Select" &&
                                  field.options.length > 0 && (
                                    <Chip
                                      label={`Options: ${field.options.join(
                                        ", "
                                      )}`}
                                      variant="outlined"
                                      size="small"
                          ...
                          <>
                            <Grid item xs={12} sm={6}>
                              <TextField
                                ...
                                onChange={(e) =>
                                  setStartCustomName(e.target.value)
                                }
                              />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                              <TextField
                                ...
                                value={endCustomName}
                                onChange={(e) =>
                                  setEndCustomName(e.target.value)
                                }
                              />
                            </Grid>
                          </>
